...
{
    public function __construct(Node $body, ?AbstractExpression $id = null, ?Node $domain = null, ?AbstractExpression $count = null, ?AbstractExpression $vars = null, ?AbstractExpression $locale = null, int $lineno = 0)
    {
        $nodes = ['body' => $body];
        if (null !== $id) {
            $nodes['id'] = $id;
